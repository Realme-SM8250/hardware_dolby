...
# Dolby
PRODUCT_COPY_FILES += \
    hardware/dolby/configs/dolby/dax-default.xml:$(TARGET_COPY_OUT_ODM)/etc/dolby/dax-default.xml \
    hardware/dolby/configs/dolby/media_codecs_dolby_audio.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_dolby_audio.xml \
    hardware/dolby/configs/dolby/config-com.dolby.daxappui.xml:$(TARGET_COPY_OUT_SYSTEM_EXT)/etc/sysconfig/config-com.dolby.daxappui.xml \
    hardware/dolby/configs/dolby/config-com.dolby.daxservice.xml:$(TARGET_COPY_OUT_SYSTEM_EXT)/etc/sysconfig/config-com.dolby.daxservice.xml \
    hardware/dolby/configs/dolby/hiddenapi-com.dolby.daxservice.xml:$(TARGET_COPY_OUT_SYSTEM_EXT)/etc/sysconfig/hiddenapi-com.dolby.daxservice.xml \
    hardware/dolby/configs/dolby/privapp-com.dolby.daxappui.xml:$(TARGET_COPY_OUT_SYSTEM_EXT)/etc/permissions/privapp-com.dolby.daxappui.xml \
    hardware/dolby/configs/dolby/privapp-com.dolby.daxservice.xml:$(TARGET_COPY_OUT_SYSTEM_EXT)/etc/permissions/privapp-com.dolby.daxservice.xml

# SEPolicy
BOARD_VENDOR_SEPOLICY_DIRS += hardware/dolby/sepolicy/vendor

# Oneplus and daxService
PRODUCT_PACKAGES += \
    DaxUI \
    daxService
...
# Proprietary blobs
PRODUCT_COPY_FILES += \
    hardware/dolby/proprietary/system_ext/priv-app/daxService/daxService.apk:$(TARGET_COPY_OUT_SYSTEM_EXT)/priv-app/daxService/daxService.apk \
    hardware/dolby/proprietary/system_ext/priv-app/DaxUI/DaxUI.apk:$(TARGET_COPY_OUT_SYSTEM_EXT)/priv-app/DaxUI/DaxUI.apk \
